%global package_speccommit ef414cf67f6e410b374ddd7e46bd15c332394cc5
%global usver 2.36.1
%global xsver 2
...
Name: devtoolset-11-binutils%{?_with_debug:-debug}
Version: 2.36.1
Release: %{?xsrel}%{?dist}
License: GPLv3+
...
Source0: binutils-2.36.1.tar.xz
Source1: binutils-2.19.50.0.1-output-format.sed
Patch0: binutils-2.20.51.0.2-libtool-lib64.patch
Patch1: binutils-2.25-version.patch
Patch2: binutils-export-demangle.h.patch
Patch3: binutils-2.22.52.0.4-no-config-h-check.patch
Patch4: binutils-2.29-filename-in-error-messages.patch
Patch5: binutils-revert-PLT-elision.patch
Patch6: binutils-2.25-set-long-long.patch
Patch7: binutils-readelf-other-sym-info.patch
Patch8: binutils-2.27-aarch64-ifunc.patch
Patch9: binutils-2.28-ignore-gold-duplicates.patch
...
Patch14: binutils-no-builder-comment-in-bfd-stdint.patch
Patch15: binutils-PELC-licence-corrections.patch
Patch16: binutils-ignore-duplicate-FDE-entries.patch
Patch17: binutils-CVE-2019-1010204.patch
Patch18: binutils-gold-warn-unsupported.patch
Patch19: binutils-2.36-branch-updates.patch
Patch20: binutils-testsuite-fixes.patch
Patch21: binutils-ppc64le-note-merge.patch
Patch22: binutils-s390-arch14-insns.patch
Patch23: binutils-CVE-2021-3530.patch
Patch24: binutils-ppc-weak-undefined-plt-relocs.patch
...
#----------------------------------------------------------------------------
%changelog
* Wed Feb 23 2022 Rachel Yan <Rachel.Yan@citrix.com> - 2.36.1-2
